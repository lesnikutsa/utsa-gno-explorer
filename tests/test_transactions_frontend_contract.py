...
class TransactionsFrontendContractTests(unittest.TestCase):
    ...
    def test_states_pagination_and_responsive_layout(self):
        ...
        self.assertIn("min-width: 1400px", transactions_rules)
        self.assertIn("grid-template-columns: max-content 64ch max-content max-content max-content max-content", transactions_rules)
        self.assertIn("justify-content: space-between; column-gap: 32px", transactions_rules)
        ...
        self.assertIn(".transactions-page__table .data-table { min-width: 1400px; }", mobile)
