...
test('detail presents validator-only identity, metrics, signing, slashing and parameters', () => {
  for (const text of ['Contact', 'Minimum Self Delegation', 'Account Address', 'Hex Address', 'Jailed', 'Identity', 'Voting Power', 'Stake Share', '≈24h Change', 'Commission', 'Recent finalized participation', 'Protocol slashing window', 'Rewards & Commission', 'Validator commission earned', 'Outstanding rewards', 'Consensus Identity', 'Consensus Public Key']) assert.match(page, new RegExp(text))
