...
test('detail presents validator-only identity, metrics, signing, slashing and economics', () => {
  ...
  assert.match(detailCss, /grid-template-columns:\s*minmax\(0, 39fr\) minmax\(0, 61fr\)/)
  ...
  assert.match(page, /v\.evm_address && <Address label="EVM Address" value=\{v\.evm_address\}/)
  ...
  assert.match(page, /remaining > 0 && <button/)
