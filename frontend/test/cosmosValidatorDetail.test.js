...
test('delegators section is independently paginated and preserves all states', () => {
  ...
  assert.match(page, /<th>Delegator<\/th><th aria-sort=.*?<button[^>]+title="Sorts currently loaded delegators only\."[\s\S]*?>Delegated<span className="data-table__sort-arrow"/)
  ...
  assert.match(page, /Sorts currently loaded delegators only\./)
