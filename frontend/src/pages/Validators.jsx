...
export function Validators({ validatorsPage }) {
  ...
  return (
    <section className="validators-page" aria-labelledby="validators-page-title">
      ...
      {historyError && hasSuccessfulHistoryResponse && <p className="validators-page__notice validators-page__notice--warning">Showing the last loaded signing history. Refresh failed.</p>}
