...
function DelegatorShares({ value }) { if (value == null) return '—'; return <span className="cosmos-validator-shares"><span>{compactShares(String(value))} shares</span><CopyButton value={String(value)} label="delegator shares" /></span> }
