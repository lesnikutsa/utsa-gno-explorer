    ...
    <>
      ...
      <section className="network-preview">
        <div className="network-preview__metrics">
          <span className="eyebrow">Preview</span><h2>Peers & Decentralization Map</h2>
          <div className="network-preview__stats" aria-label="Peer metrics preview">
        ...
        <div className="network-preview__map">
          <img src={networkMap} alt="Stylized preview of global network coverage" />
        </div>
        <aside className="network-preview__glance" aria-label="Network at a glance">
          <h3>Network at a glance</h3>
          <ul>
            <li>Strong global reach</li>
            <li>Low latency connections</li>
            <li>Healthy peer diversity</li>
            <li>Resilient &amp; decentralized</li>
          </ul>
        </aside>
        <div className="network-preview__mascot" aria-hidden="true"><img src={mascotSrc} alt="" /></div>
      </section>
