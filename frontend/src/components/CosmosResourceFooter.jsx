...
export function CosmosResourceFooter() {
  return <footer className="cosmos-footer"><div className="resource-strip" aria-label="Explorer resources"><div className="resource-guides"><small>UTSA Guides</small><div><Link href="https://utsa.gitbook.io/services">English</Link><Link href="https://teletype.media/@lesnik13utsa">Русский</Link></div></div></div><p>Explorer by UTSA</p></footer>
}
