...
Independent explorer and infrastructure project for Gno.land Topaz.
...
**v1.0.0** is the first stable Topaz release. The active chain ID is `topaz-1`.
...
- access to one or more Topaz RPC endpoints.
