# Historical bounded-indexer runbook

> **Archive:** This document describes the former bounded prototype and is not current production guidance. See [the current operator runbook](../operator-runbook.md).
