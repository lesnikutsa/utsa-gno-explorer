...
Verify service-user access and confirm that `find` reports no group-writable regular file or directory (the explicit types avoid treating symbolic links as writable targets):
